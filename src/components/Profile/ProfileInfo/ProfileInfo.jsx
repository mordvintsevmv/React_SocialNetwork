    ...
    return (<div className={ProfileInfoCSS.info_wrapper}>
        ...
        <div className={ProfileInfoCSS.info_block}>
            ...
            <div className={ProfileInfoCSS.text_info}>
                ...
                <ProfileStatus lookingForAJobDescription={props.profile.lookingForAJobDescription} status={props.profile.status} myID={props.myID} id={props.profile.userId} updateStatus={props.updateStatus} updatePhoto={props.updatePhoto}/>
            </div>
        </div>
